...
document.addEventListener('turbo:load', function() {
    const initialUf = <?php echo json_encode($lei->estado ?? old('lei.estado'), 15, 512) ?>;
    const initialCity = <?php echo json_encode($lei->cidade ?? old('lei.cidade'), 15, 512) ?>;
...
</script><?php /**PATH D:\leisdatabase.com\resources\views/orchid/partials/location-selector.blade.php ENDPATH**/ ?>
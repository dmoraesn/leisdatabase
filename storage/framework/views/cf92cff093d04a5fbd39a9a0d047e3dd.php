<a href="<?php echo e(route('platform.notifications')); ?>"
   ...
   data-notification-interval="<?php echo e(config('platform.notifications.interval')); ?>"
>
...
<?php $component = Orchid\Icons\IconComponent::resolve(['path' => 'bs.bell'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
    ...
    <template id="notification-circle">
        <?php if (isset($component)) { $__componentOriginal385240e1db507cd70f0facab99c4d015 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal385240e1db507cd70f0facab99c4d015 = $attributes; } ?>
<?php $component = Orchid\Icons\IconComponent::resolve(['path' => 'bs.circle-fill','width' => '0.4em','height' => '0.4em'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('orchid-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php /**PATH D:\leisdatabase.com\vendor\orchid\platform\resources\views/components/notification.blade.php ENDPATH**/ ?>
<div class="d-flex justify-content-center gap-1">
    <a href="<?php echo e(route('platform.leis.edit', $lei)); ?>"
...
<?php $component = Orchid\Icons\IconComponent::resolve(['path' => 'pencil'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
    ...
    <form method="POST"
          action="<?php echo e(route('platform.leis.list')); ?>"
          style="display:inline">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="id" value="<?php echo e($lei->id); ?>">
        <button class="btn btn-sm btn-outline-warning"
                formaction="<?php echo e(route('platform.leis.list', ['method' => 'reprocessar'])); ?>"
                title="Reprocessar">
            <?php if (isset($component)) { $__componentOriginal385240e1db507cd70f0facab99c4d015 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal385240e1db507cd70f0facab99c4d015 = $attributes; } ?>
<?php $component = Orchid\Icons\IconComponent::resolve(['path' => 'reload'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('orchid-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php /**PATH D:\leisdatabase.com\resources\views/orchid/partials/leis-actions.blade.php ENDPATH**/ ?>